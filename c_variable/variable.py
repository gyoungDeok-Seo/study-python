...
# 변수 선언(format 함수를 값으로 사용)
korean1, korean2, korean3 = '파이썬', '장고', '리엑트'
english1, english2, english3 = 'Python', 'Django', 'React'
# 자동으로 해당 순서에 값이 반영된다.
program1 = 'Hello {}, {} is fantastic !'.format(korean1, english1)

# 값에 할당된 번호를 작성하면 해당 값이 반영된다.
program2 = 'Hello {}, {} is fantastic !'.format(korean2, english2)

# 값에 이름을 붙이면 해당 이름에 있는 값이 반영된다.
program3 = 'Hello {}, {} is fantastic !'.format(korean3, english3)
...
# 실습3
# 아래 메세지를 format string을 사용하여 출력한다.
# Hello 파이썬, Python is fantastic !
# Hello 장고, Django is fantastic !
# Hello 리액트, React is fantastic !
# 변수 선언(format string을 값으로 사용)
korean1, korean2, korean3 = '파이썬', '장고', '리엑트'
english1, english2, english3 = 'Python', 'Django', 'React'
program1 = f'Hello {korean1}, {english1} is fantastic !'
program2 = f'Hello {korean2}, {english2} is fantastic !'
program3 = f'Hello {korean3}, {english3} is fantastic !'
# 변수 출력
print(program1)
print(program2)
print(program3)
