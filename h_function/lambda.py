...
# datas = [2, 4, 6, 8]
# datas = list(map(lambda number: number * 2, datas))
# print(datas)

# 각 경로 앞에 '/app'를 붙여준다.
# urls = ['/game', '/news', '/fashion', '/rangking']
...
# ['/app/game', '/app/news', '/app/fashion', '/app/rangking']
# 'game' 서비스를 제공하는 경로 찾기
# urls = ['/app/game', '/app/news', '/app/fashion', '/app/rangking']
